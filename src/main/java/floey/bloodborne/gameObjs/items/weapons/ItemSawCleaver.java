...
public class ItemSawCleaver extends ItemBloodborneWeapon {

    public ItemSawCleaver(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builderIn) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        if (Screen.hasShiftDown()) {
            tooltip.add(new TranslationTextComponent(BloodborneTranslation.TOOLTIP_ITEM_SAW_CLEAVER.getLang()).mergeStyle(TextFormatting.DARK_GRAY));
        } else
